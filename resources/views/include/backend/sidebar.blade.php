<aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
      <div class="logo-icon">
        <img src="{{asset('backend/assets/images/sb.jpg')}}" class="logo-img" alt="">
      </div>
      <div class="logo-name flex-grow-1">
        <h5 class="mb-0">Web Samudra Bahari</h5>
      </div>
        ...
        <ul class="metismenu" id="sidenav">
          ...
          <li>
            <a href="{{route('produk.index')}}">
              ...
              <div class="menu-title">Tabel Produk</div>
            </a>
          </li>
          <li>
            <a href="{{route('agen.index')}}">
              ...
              <div class="menu-title">Tabel Agen</div>
            </a>
          </li>
          {{-- <li>
            <a href="cards.html">
