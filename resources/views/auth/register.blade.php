            ...
            <div class="card rounded-4 mb-0 border-top border-4 border-primary border-gradient-1">
              <div class="card-body p-5">
                  ...
                  <div class="form-body my-4">
                        ...
                        <div class="col-md-12">
												<input id="inputUsername" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                {{-- <input id="jk" type="text" class="form-control @error('jk') is-invalid @enderror" name="jenis_kelamin" value="{{ old('jk') }}" required autocomplete="jenis_kelamin" autofocus> --}}
                                    <select name="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" required>
                                ...
                                @enderror
											...
											{{-- <div class="col-12">
												...
												<input type="email" class="form-control" id="inputEmailAddress" placeholder="e-mail" name="email">
											</div> --}}
                      <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
                                ...
                                @enderror
											...
											{{-- <div class="col-12">
												...
												<select class="form-select" id="inputSelectCountry" aria-label="Default select example">
													...
													<option value="1">Indosesia</option>
                                ...
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
											...
											<div class="col-12">
												<div class="text-start">
													<p class="mb-0">Apakah Anda Sudah Punya Akun? <a href="{{route('login')}}">Sign in here</a></p>
												</div>
											</div>
										</form>
									</div>
