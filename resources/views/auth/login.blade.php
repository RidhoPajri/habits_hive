							...
							<form method="POST" action="{{ route('login') }}" class="row g-3">
								...
								<div class="col-md-6">
									<div class="form-check form-switch">
										...
										<label class="form-check-label" for="flexSwitchCheckChecked">Remember Me</label>
											...
											{{-- <div class="col-md-6 text-end">	<a href="{{asset('backend/auth-basic-forgot-password.html')}}">Forgot Password ?</a>
											</div> --}}
								<div class="col-12">
									<div class="d-grid">
								...
								<div class="col-12">
									<div class="text-start">
										<p class="mb-0">Buat Akun <a href="{{route('register')}}">Sign up here</a>
										</p>
									</div>
								</div>
							</form>
